...
;(function() {
  ...
  var options = {
    'maxPageWidth' :     '1000px',                      // set overlay width to match page width (as max-width for flexible grids)
    'columnWidth' :      '90px',                       // set column width in px, em or %
    'columnCount' :       10,                            // set column count
    'columnColor' :      'rgba(255, 0, 0, 0.25)',       // set column color
    'gutterWidth' :      '11px',                        // set gutter width in px, em or %
    'baselineHeight' :    22,                           // set baseline height (requires pixels for now)
  ...
  // style gridOverlay element (max-width is overwritten manually for tutorial to compensate for body padding. padding and border box added for same reason)
  gridOverlay.style.cssText = '\
    display: ' + options.initialDisplay + '; \
    position: absolute; top: 0; right: 0; bottom: 0; left: 0; margin: 0 auto; width: 100%; padding: 0 1em; box-sizing: border-box; \
    max-width: 1032px; \
