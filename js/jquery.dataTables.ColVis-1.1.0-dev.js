 ...
 * File:        ColVis.js
 * Version:     1.1.0-dev
 * CVS:         $Id: jquery.dataTables.ColVis-1.1.0-dev.js,v 1.1 2013/09/19 17:08:28 erg208 Exp $
 * Description: Controls for column visiblity in DataTables
 * Author:      Allan Jardine (www.sprymedia.co.uk)
 * Created:     Wed Sep 15 18:23:29 BST 2010
 * Modified:    $Date: 2013/09/19 17:08:28 $ by $Author: erg208 $
 * Language:    Javascript
...
ColVis.prototype = {
	...
	"_fnDomBaseButton": function ( text )
	{
		...
		$(nButton).bind( sEvent, function (e) {
			// erg - 09/18/2013 - Added conditionally either show or hide
			if (that.s.hidden) {
