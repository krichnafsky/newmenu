...
//							$(document).trigger('close.facebox');
							ehrsDirtyFormsModalDialogHide();
							decision(e);
						};
					};
//					$('#facebox .cancel, #facebox .close, #facebox_overlay').click(close(decidingCancel));
					$('#ehrsDirtyFormsModalDialog .modal-footer .cancel').click(close(decidingCancel));
//					$('#facebox .continue').click(close(decidingContinue));
					$('#ehrsDirtyFormsModalDialog .modal-footer .continue').click(close(decidingContinue));
				},
				stash : function(){
//					var fb = $('#facebox');
...
//					   $('#facebox .content').clone(true);
				...
				selector : '#ehrsDirtyFormsModalDialog'
